...
var IdealImageSlider = function() {
    ...
    var a = function(a, b) {
        ...
        e = function(a) {
            ...
            for (var b = 1; b < arguments.length; b++) {
                var d = arguments[b];
                if (d)
                    for (var f in d) d.hasOwnProperty(f) && (c("Object", d[f]) && null !== d[f] ? e(a[f], d[f]) : a[f] = d[f])
            }
            return a
        },
        f = function(a, b) {
        ...
        p = function(a, b) {
            if ("undefined" == typeof b && (b = !0), !d(a.settings.height)) {
                var c = Math.round(a._attributes.container.offsetHeight),
                    e = c;
                if (a._attributes.aspectWidth && a._attributes.aspectHeight) e = a._attributes.aspectHeight / a._attributes.aspectWidth * a._attributes.container.offsetWidth;
                else {
        ...
        q = {
            ...
            transitionEnd: function(a) {
                if (q.vars.direction) {
                    ...
                    var b = this._attributes.slides,
                        c = b.indexOf(this._attributes.currentSlide);
        ...
        r = function(a) {
            ...
            if (this._attributes = {
                    ...
                    aspectWidth: 0,
                    aspectHeight: 0
                }, d(this.settings.height)) this._attributes.container.style.height = this.settings.height + "px";
            else {
    ...
    return r.prototype.get = function(a) {
        ...
        var a = this._attributes.slides,
            c = a.indexOf(this._attributes.currentSlide);
        ...
        var c = this._attributes.slides,
            d = c.indexOf(this._attributes.currentSlide);
